...
def _safe_report_summary(report: dict[str, Any], *, currentity: str) -> dict[str, Any]:
    ...
    return {
        ...
        "gpu_execution_contract_version": report.get("gpu_execution_contract_version") or "",
        "gpu_execution_requested": report.get("gpu_execution_requested") or "",
        "gpu_execution_segments": report.get("gpu_execution_segments") or [],
